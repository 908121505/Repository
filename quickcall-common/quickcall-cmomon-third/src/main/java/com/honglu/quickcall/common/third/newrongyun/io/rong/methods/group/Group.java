package com.honglu.quickcall.common.third.newrongyun.io.rong.methods.group;

import java.net.HttpURLConnection;
import java.net.URLEncoder;

import com.honglu.quickcall.common.third.newrongyun.io.rong.RongCloud;
import com.honglu.quickcall.common.third.newrongyun.io.rong.exception.ParamException;
import com.honglu.quickcall.common.third.newrongyun.io.rong.methods.group.gag.Gag;
import com.honglu.quickcall.common.third.newrongyun.io.rong.models.CheckMethod;
import com.honglu.quickcall.common.third.newrongyun.io.rong.models.CommonConstrants;
import com.honglu.quickcall.common.third.newrongyun.io.rong.models.Result;
import com.honglu.quickcall.common.third.newrongyun.io.rong.models.group.GroupMember;
import com.honglu.quickcall.common.third.newrongyun.io.rong.models.group.GroupModel;
import com.honglu.quickcall.common.third.newrongyun.io.rong.models.group.UserGroup;
import com.honglu.quickcall.common.third.newrongyun.io.rong.models.response.GroupUserQueryResult;
import com.honglu.quickcall.common.third.newrongyun.io.rong.models.response.ResponseResult;
import com.honglu.quickcall.common.third.newrongyun.io.rong.util.CommonUtil;
import com.honglu.quickcall.common.third.newrongyun.io.rong.util.GsonUtil;
import com.honglu.quickcall.common.third.newrongyun.io.rong.util.HttpUtil;
...
public class Group {
	 ...
	 *
	 * url /group/create.json docs http://rongcloud.cn/docs/server.html#group_sync"
	 *
	 * @param group
	 *            创建群组的群组信息
	 *
	...
	public Result create(GroupModel group) throws Exception {
		...
		return (ResponseResult) GsonUtil.fromJson(
				CommonUtil.getResponseByCode(PATH, CheckMethod.CREATE, HttpUtil.returnResult(conn)),
	...
	public Result sync(UserGroup user) throws Exception {
		...
		for (int i = 0; i < user.getGroups().length; i++) {
			...
			if (child.getName() == null) {
				throw new ParamException(CommonConstrants.RCLOUD_PARAM_NULL, "/group/sync",
						"Paramer 'group.name' is required");
			}
			if (child.getId() == null) {
				throw new ParamException(CommonConstrants.RCLOUD_PARAM_NULL, "/group/sync",
						"Paramer 'group.id' is required");
			}
		...
		HttpURLConnection conn = HttpUtil.CreatePostHttpConnection(rongCloud.getApiHostType(), appKey, appSecret,
				"/group/sync.json", "application/x-www-form-urlencoded");
		HttpUtil.setBodyParameter(body, conn);

		return (ResponseResult) GsonUtil.fromJson(
				CommonUtil.getResponseByCode(PATH, CheckMethod.SYNC, HttpUtil.returnResult(conn)),
				ResponseResult.class);
	}
	...
	public Result update(GroupModel group) throws Exception {
		...
		HttpUtil.setBodyParameter(body, conn);
		return (ResponseResult) GsonUtil.fromJson(
				CommonUtil.getResponseByCode(PATH, CheckMethod.UPDATE, HttpUtil.returnResult(conn)),
				ResponseResult.class);
	}
	...
	public Result invite(GroupModel group) throws Exception {
		...
		HttpURLConnection conn = HttpUtil.CreatePostHttpConnection(rongCloud.getApiHostType(), appKey, appSecret,
				"/group/join.json", "application/x-www-form-urlencoded");
		HttpUtil.setBodyParameter(body, conn);

		return (ResponseResult) GsonUtil.fromJson(
				CommonUtil.getResponseByCode(PATH, CheckMethod.INVITE, HttpUtil.returnResult(conn)),
				ResponseResult.class);
	}
	...
	public Result join(GroupModel group) throws Exception {
		...
		return (ResponseResult) GsonUtil.fromJson(
				CommonUtil.getResponseByCode(PATH, CheckMethod.JOIN, HttpUtil.returnResult(conn)),
				ResponseResult.class);
	}
	...
	public GroupUserQueryResult get(GroupModel group) throws Exception {
		...
		return (GroupUserQueryResult) GsonUtil.fromJson(
				CommonUtil.getResponseByCode(PATH, CheckMethod.GET, HttpUtil.returnResult(conn)),
				GroupUserQueryResult.class);
	}
	...
	public Result quit(GroupModel group) throws Exception {
		...
		HttpURLConnection conn = HttpUtil.CreatePostHttpConnection(rongCloud.getApiHostType(), appKey, appSecret,
				"/group/quit.json", "application/x-www-form-urlencoded");
		HttpUtil.setBodyParameter(body, conn);

		return (ResponseResult) GsonUtil.fromJson(
				CommonUtil.getResponseByCode(PATH, CheckMethod.QUIT, HttpUtil.returnResult(conn)),
				ResponseResult.class);
	}
	...
	public Result dismiss(GroupModel group) throws Exception {
		...
		return (ResponseResult) GsonUtil.fromJson(
				CommonUtil.getResponseByCode(PATH, CheckMethod.DISMISS, HttpUtil.returnResult(conn)),
				ResponseResult.class);
	}
}