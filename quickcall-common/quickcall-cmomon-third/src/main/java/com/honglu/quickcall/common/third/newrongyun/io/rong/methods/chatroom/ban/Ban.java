package com.honglu.quickcall.common.third.newrongyun.io.rong.methods.chatroom.ban;
...
import com.honglu.quickcall.common.third.newrongyun.io.rong.models.response.ListGagChatroomUserResult;
...
public class Ban {
	...
	public ResponseResult add(ChatroomModel chatroom) throws Exception {
		...
		HttpURLConnection conn = HttpUtil.CreatePostHttpConnection(rongCloud.getApiHostType(), appKey, appSecret,
				"/chatroom/user/ban/add.json", "application/x-www-form-urlencoded");
	...
	public ListGagChatroomUserResult getList() throws Exception {
		...
		HttpURLConnection conn = HttpUtil.CreatePostHttpConnection(rongCloud.getApiHostType(), appKey, appSecret,
				"/chatroom/user/ban/query.json", "application/x-www-form-urlencoded");

		return (ListGagChatroomUserResult) GsonUtil.fromJson(
	...
	public ResponseResult remove(ChatroomModel chatroom) throws Exception {
		if (chatroom == null) {
			throw new ParamException(CommonConstrants.RCLOUD_PARAM_NULL, "/chatroom/user/ban/remove",
		...
		HttpURLConnection conn = HttpUtil.CreatePostHttpConnection(rongCloud.getApiHostType(), appKey, appSecret,
				"/chatroom/user/ban/remove.json", "application/x-www-form-urlencoded");
		HttpUtil.setBodyParameter(body, conn);
