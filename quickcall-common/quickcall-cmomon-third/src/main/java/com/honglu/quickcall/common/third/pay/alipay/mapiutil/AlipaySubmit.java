package com.honglu.quickcall.common.third.pay.alipay.mapiutil;

import com.honglu.quickcall.common.third.pay.alipay.AlipayConfig;
import com.honglu.quickcall.common.third.pay.alipay.mapiutil.httpClient.HttpProtocolHandler;
import com.honglu.quickcall.common.third.pay.alipay.mapiutil.httpClient.HttpRequest;
import com.honglu.quickcall.common.third.pay.alipay.mapiutil.httpClient.HttpResponse;
import com.honglu.quickcall.common.third.pay.alipay.mapiutil.httpClient.HttpResultType;
...
public class AlipaySubmit {
	...
	public static String buildRequestMysign(Map<String, String> sPara) {
        ...
        String mysign = "";
        if(AlipayConfig.mapi_sign_type.equals("MD5") ) {
        	mysign = MD5.sign(prestr, AlipayConfig.mapiKey, AlipayConfig.input_charset);
        }
        return mysign;
    }
    ...
    private static Map<String, String> buildRequestPara(Map<String, String> sParaTemp) {
        ...
        sPara.put("sign_type", AlipayConfig.mapi_sign_type);
