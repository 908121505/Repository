package com.honglu.quickcall.common.third.newrongyun.io.rong.methods.chatroom.block;
...
import com.honglu.quickcall.common.third.newrongyun.io.rong.models.response.ListBlockChatroomUserResult;
...
public class Block {
	...
	public ListBlockChatroomUserResult getList(String chatroomId) throws Exception {
		...
		return (ListBlockChatroomUserResult) GsonUtil.fromJson(
