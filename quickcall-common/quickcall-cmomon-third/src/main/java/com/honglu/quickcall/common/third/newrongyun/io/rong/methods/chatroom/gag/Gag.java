package com.honglu.quickcall.common.third.newrongyun.io.rong.methods.chatroom.gag;
...
public class Gag {
	 ...
	 *
	 * @param chatroom:封禁的聊天室信息，其中聊天室
	 *            d（必传）,minute(必传), memberIds（必传支持多个最多20个）
	 *
	...
	public ResponseResult add(ChatroomModel chatroom) throws Exception {
		 ...
		 * (ResponseResult)GsonUtil.fromJson(message,ResponseResult.class); }
		 */
