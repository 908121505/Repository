...
public enum SmsTemplateEnum {
    login_auth_code_template("login_auth_code_template","【卡卡社区】您的验证码是{0}，请在10分钟内完成操作。为了您的账户安全，请勿泄露给他人。"),
    mdwy_login_auth_code_template("mdwy_login_auth_code_template","【喵无忧】您的验证码是{0}，请在10分钟内完成操作。为了您的账户安全，请勿泄露给他人。")
