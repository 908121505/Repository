package com.honglu.quickcall.common.third.newrongyun.io.rong.methods.chatroom;
...
import com.honglu.quickcall.common.third.newrongyun.io.rong.methods.chatroom.ban.Ban;
import com.honglu.quickcall.common.third.newrongyun.io.rong.methods.chatroom.block.Block;
import com.honglu.quickcall.common.third.newrongyun.io.rong.methods.chatroom.demotion.Demotion;
import com.honglu.quickcall.common.third.newrongyun.io.rong.methods.chatroom.distribute.Distribute;
import com.honglu.quickcall.common.third.newrongyun.io.rong.methods.chatroom.gag.Gag;
import com.honglu.quickcall.common.third.newrongyun.io.rong.methods.chatroom.keepalive.Keepalive;
import com.honglu.quickcall.common.third.newrongyun.io.rong.methods.chatroom.whitelist.Whitelist;
...
public class Chatroom {
	...
	public ResponseResult create(ChatroomModel[] chatrooms) throws Exception {
		if (chatrooms == null) {
			throw new ParamException(CommonConstrants.RCLOUD_PARAM_NULL, "/chatroom/create",
					"Paramer 'chatrooms' is required");
		}
	...
	public ResponseResult destroy(ChatroomModel chatroom) throws Exception {
		if (chatroom == null) {
			throw new ParamException(CommonConstrants.RCLOUD_PARAM_NULL, "/chatroom/destroy",
					"Paramer 'chatroomId' is required");
		}
		...
		return (ResponseResult) GsonUtil.fromJson(
				CommonUtil.getResponseByCode(PATH, CheckMethod.DESTORY, HttpUtil.returnResult(conn)),
				ResponseResult.class);
	}
	...
	public CheckChatRoomUserResult isExist(ChatroomMember member) throws Exception {
		...
		HttpURLConnection conn = HttpUtil.CreatePostHttpConnection(rongCloud.getApiHostType(), appKey, appSecret,
				"/chatroom/user/exist.json", "application/x-www-form-urlencoded");
		HttpUtil.setBodyParameter(body, conn);

		return (CheckChatRoomUserResult) GsonUtil.fromJson(
				CommonUtil.getResponseByCode(PATH, CheckMethod.ISEXIST, HttpUtil.returnResult(conn)),
				CheckChatRoomUserResult.class);
	}
}