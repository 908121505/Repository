package com.honglu.quickcall.common.third.newrongyun.io.rong.example.message;
...
import com.honglu.quickcall.common.third.newrongyun.io.rong.messages.CustomTxtMessage;
import com.honglu.quickcall.common.third.newrongyun.io.rong.messages.TxtMessage;
import com.honglu.quickcall.common.third.newrongyun.io.rong.messages.VoiceMessage;
import com.honglu.quickcall.common.third.newrongyun.io.rong.methods.message._private.Private;
import com.honglu.quickcall.common.third.newrongyun.io.rong.methods.message.chatroom.Chatroom;
import com.honglu.quickcall.common.third.newrongyun.io.rong.methods.message.discussion.Discussion;
import com.honglu.quickcall.common.third.newrongyun.io.rong.methods.message.group.Group;
import com.honglu.quickcall.common.third.newrongyun.io.rong.methods.message.history.History;
import com.honglu.quickcall.common.third.newrongyun.io.rong.methods.message.system.MsgSystem;
import com.honglu.quickcall.common.third.newrongyun.io.rong.models.message.BroadcastMessage;
import com.honglu.quickcall.common.third.newrongyun.io.rong.models.message.ChatroomMessage;
import com.honglu.quickcall.common.third.newrongyun.io.rong.models.message.DiscussionMessage;
import com.honglu.quickcall.common.third.newrongyun.io.rong.models.message.GroupMessage;
import com.honglu.quickcall.common.third.newrongyun.io.rong.models.message.MentionMessage;
import com.honglu.quickcall.common.third.newrongyun.io.rong.models.message.MentionMessageContent;
import com.honglu.quickcall.common.third.newrongyun.io.rong.models.message.MentionedInfo;
import com.honglu.quickcall.common.third.newrongyun.io.rong.models.message.PrivateMessage;
import com.honglu.quickcall.common.third.newrongyun.io.rong.models.message.RecallMessage;
import com.honglu.quickcall.common.third.newrongyun.io.rong.models.message.SystemMessage;
import com.honglu.quickcall.common.third.newrongyun.io.rong.models.message.TemplateMessage;
import com.honglu.quickcall.common.third.newrongyun.io.rong.models.response.HistoryMessageResult;
...
public class MessageExample {
	...
	public static void main(String[] args) throws Exception {
		...
		/**
		 * API 文档:
		 * http://www.rongcloud.cn/docs/server_sdk_api/message/system.html#sendTemplate
		 *
		 * 发送系统模板消息方法
		 *
		 */
		Reader reader = null;
		try {
			reader = new BufferedReader(new InputStreamReader(MessageExample.class.getClassLoader()
		 ...
		 *
		 */
		BroadcastMessage message = new BroadcastMessage().setSenderId("Hji8yh76").setObjectName(txtMessage.getType())
		 ...
		 * 发送单聊消息
		 */
		PrivateMessage privateMessage = new PrivateMessage().setSenderId("2609751433442958892").setTargetId(targetIds)
		...
		/**
		 * API 文档:
		 * http://www.rongcloud.cn/docs/server_sdk_api/message/private.html#sendTemplate
		 *
		 * 发送单聊模板消息方法
		 */
		try {
		...
		/**
		 * API 文档:
		 * http://www.rongcloud.cn/docs/server_sdk_api/message/private.html#recall
		 *
		 * 撤回单聊消息
		 */
		RecallMessage recallMessage = new RecallMessage().setSenderId("2609751433442958892")
				.setTargetId("2651280140445094444").setuId("5H6P-CGC6-44QR-VB3R").setSentTime("1519444243981");
		 ...
		 * 群组消息
		 */
		GroupMessage groupMessage = new GroupMessage().setSenderId("userId").setTargetId(targetIds)
				.setObjectName(txtMessage.getType()).setContent(txtMessage).setPushContent("this is a push")
		 ...
		 * 群组撤回消息
		 */
		recallMessage = new RecallMessage().setSenderId("sea9901").setTargetId("markoiwm").setuId("5GSB-RPM1-KP8H-9JHF")
		...
		/**
		 * API 文档:
		 * http://www.rongcloud.cn/docs/server_sdk_api/message/group.html#sendMention
		 *
		 * 群组@消息
		 */
		// 要@的人
		...
		MentionMessage mentionMessage = new MentionMessage().setSenderId("userId").setTargetId(targetIds)
		...
		/**
		 * API 文档:
		 * http://www.rongcloud.cn/docs/server_sdk_api/message/discussion.html#send
		 *
		 * 发送讨论组消息
		 */
		String[] discussionIds = { "lijhGk87", "lijhGk88" };
		DiscussionMessage discussionMessage = new DiscussionMessage().setSenderId("JuikH78ko")
				.setTargetId(discussionIds).setObjectName(txtMessage.getType()).setContent(txtMessage)
				.setPushContent("this is a push").setPushData("{\"pushData\":\"hello\"}").setIsPersisted(0)
				.setIsCounted(0).setIsIncludeSender(0).setContentAvailable(0);
		...
		/**
		 * API 文档:
		 * http://www.rongcloud.cn/docs/server_sdk_api/message/discussion.html#recall
		 *
		 * 撤回讨论组消息
		 */
		recallMessage = new RecallMessage().setSenderId("sea9901").setTargetId("IXQhMs3ny")
				.setuId("5GSB-RPM1-KP8H-9JHF").setSentTime("1519444243981");
		...
		/**
		 * API 文档:
		 * http://www.rongcloud.cn/docs/server_sdk_api/message/chatroom.html#send
		 *
		 * 聊天室消息
		 */
		...
		ChatroomMessage chatroomMessage = new ChatroomMessage().setSenderId("1").setTargetId(chatroomIds)
				.setContent(ctm).setObjectName(ctm.getType());
		 ...
		 *
		 * API 文档:
		 * http://www.rongcloud.cn/docs/server_sdk_api/message/chatroom.html#broadcast
		 *
		 * 聊天室广播消息
		 *
		 ...
		 *
		 */
		chatroomMessage = new ChatroomMessage().setSenderId("bN6oQi8T5").setContent(txtMessage)
