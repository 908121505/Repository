package com.honglu.quickcall.common.third.newrongyun.io.rong.methods.conversation;
...
public class Conversation {
	...
	public ResponseResult mute(ConversationModel conversation) throws Exception {
		...
		HttpURLConnection conn = HttpUtil.CreatePostHttpConnection(rongCloud.getApiHostType(), appKey, appSecret,
				"/conversation/notification/set.json", "application/x-www-form-urlencoded");
		HttpUtil.setBodyParameter(body, conn);

		return (ResponseResult) GsonUtil.fromJson(
				CommonUtil.getResponseByCode(PATH, CheckMethod.MUTE, HttpUtil.returnResult(conn)),
	...
	public ResponseResult unMute(ConversationModel conversation) throws Exception {
		...
		return (ResponseResult) GsonUtil.fromJson(
				CommonUtil.getResponseByCode(PATH, CheckMethod.UNMUTE, HttpUtil.returnResult(conn)),
				ResponseResult.class);
	}
}
