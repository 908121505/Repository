package com.honglu.quickcall.common.third.newrongyun.io.rong.example.group;

import com.honglu.quickcall.common.third.newrongyun.io.rong.RongCloud;
import com.honglu.quickcall.common.third.newrongyun.io.rong.methods.group.Group;
...
public class GroupExample {
	...
	public static void main(String[] args) throws Exception {
		...
		UserGroup user = new UserGroup().setId("jhkoi90jj").setGroups(groups);
		 ...
		 * 刷新群组信息方法
		 */
		// GroupMember[] members = {new GroupMember().setId("ghJiu7H1"),new
		// GroupMember().setId("ghJiu7H2")};

		group = new GroupModel().setId("groupId").setName("groupName");
		 ...
		 *
		 */
		group = new GroupModel().setId("hdiuj87jj").setMembers(members).setName("groupName");
		 ...
		 *
		 */
		group = new GroupModel().setId("groupId").setMembers(members).setName("groupName");
		Result groupJoinResult = (Result) Group.join(group);
		System.out.println("join:  " + groupJoinResult.toString());

		/**
		 * API 文档:
		 * http://www.rongcloud.cn/docs/server_sdk_api/group/group.html#getMembers
		 *
		 * 查询群成员方法
		 *
		 */
		...
		group = new GroupModel().setId("groupId").setMembers(members);
