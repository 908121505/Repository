package com.honglu.quickcall.common.third.newrongyun.io.rong.methods.user.onlinestatus;
...
import com.honglu.quickcall.common.third.newrongyun.io.rong.models.response.CheckOnlineResult;
...
public class OnlineStatus {
	 ...
	 *
	 * url /user/checkOnline docs
	 * http://www.rongcloud.cn/docs/server.html#user_check_online
	 *
	 * @param user:用户
	 *            id(必传)
	 *
	...
	public CheckOnlineResult check(UserModel user) throws Exception {
		...
		return (CheckOnlineResult) GsonUtil.fromJson(
				CommonUtil.getResponseByCode(PATH, CheckMethod.CHECK, HttpUtil.returnResult(conn)),
				CheckOnlineResult.class);
	}
}
