package com.honglu.quickcall.common.third.newrongyun.io.rong.methods.message.group;
...
public class Group {
	...
	/**
	 * 发送群组@消息方法（以一个用户身份向群组发送消息，单条消息最大 128k.每秒钟最多发送 20 条消息，每次最多向 3 个群组发送，如：一次向 3
	 * 个群组发送消息，示为 3 条消息。）
	 *
	 * @param message
	 *
