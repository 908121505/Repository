...
import com.honglu.quickcall.common.third.newrongyun.io.rong.models.response.ChatroomWhitelistMsgResult;
 ...
 *
 * 聊天室消息白名单服务 docs:
 * "http://www.rongcloud.cn/docs/server.html#chatroom_whitelist"
 *
 */
public class Messages {
	...
	public ResponseResult add(String[] objectNames) throws Exception {
		...
		HttpURLConnection conn = HttpUtil.CreatePostHttpConnection(rongCloud.getApiHostType(), appKey, appSecret,
				"/chatroom/whitelist/add.json", "application/x-www-form-urlencoded");
	...
	public ResponseResult remove(String[] objectNames) throws Exception {
		...
		HttpURLConnection conn = HttpUtil.CreatePostHttpConnection(rongCloud.getApiHostType(), appKey, appSecret,
				"/chatroom/whitelist/delete.json", "application/x-www-form-urlencoded");
		HttpUtil.setBodyParameter(body, conn);
	...
	public ChatroomWhitelistMsgResult getList() throws Exception {
		...
		HttpURLConnection conn = HttpUtil.CreatePostHttpConnection(rongCloud.getApiHostType(), appKey, appSecret,
				"/chatroom/whitelist/query.json", "application/x-www-form-urlencoded");
		return (ChatroomWhitelistMsgResult) GsonUtil.fromJson(
				CommonUtil.getResponseByCode(PATH, CheckMethod.GETLIST, HttpUtil.returnResult(conn)),
				ChatroomWhitelistMsgResult.class);
	}
}
