package com.honglu.quickcall.common.third.newrongyun.io.rong.example.sensitive;

import com.honglu.quickcall.common.third.newrongyun.io.rong.RongCloud;
import com.honglu.quickcall.common.third.newrongyun.io.rong.methods.sensitive.SensitiveWord;
...
public class SensitiveExample {
	...
	public static void main(String[] args) throws Exception {
		...
		/**
		 * API 文档:
		 * http://www.rongcloud.cn/docs/server_sdk_api/sensitive/sensitive.html#add
		 *
		 * 添加替换敏感词方法
		 *
		 */
		 ...
		 *
		 */
		sentiveWord = new SensitiveWordModel().setType(1).setKeyword("黄赌毒");
		 ...
		 *
		 * API 文档:
		 * http://www.rongcloud.cn/docs/server_sdk_api/sensitive/sensitive.html#getList
		 * 查询敏感词列表方法
		 *
		 */
		 ...
		 *
		 * API 文档:
		 * http://www.rongcloud.cn/docs/server_sdk_api/sensitive/sensitive.html#remove
