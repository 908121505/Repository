package com.honglu.quickcall.common.third.newrongyun.io.rong.methods.chatroom.distribute;
...
public class Distribute {
	...
	public ResponseResult stop(ChatroomModel chatroom) throws Exception {
		...
		return (ResponseResult) GsonUtil.fromJson(
				CommonUtil.getResponseByCode(PATH, CheckMethod.STOP_DISTRIBUTION, HttpUtil.returnResult(conn)),
	...
	public ResponseResult resume(ChatroomModel chatroom) throws Exception {
		...
		return (ResponseResult) GsonUtil.fromJson(
				CommonUtil.getResponseByCode(PATH, CheckMethod.RESUME_DISTRIBUTION, HttpUtil.returnResult(conn)),
				ResponseResult.class);
	}
}
