package com.honglu.quickcall.common.third.newrongyun.io.rong.methods.chatroom.keepalive;
...
import com.honglu.quickcall.common.third.newrongyun.io.rong.models.response.ChatroomKeepaliveResult;
...
public class Keepalive {
	...
	public ResponseResult add(ChatroomModel chatroom) throws Exception {
		...
		HttpURLConnection conn = HttpUtil.CreatePostHttpConnection(rongCloud.getApiHostType(), appKey, appSecret,
				"/chatroom/keepalive/add.json", "application/x-www-form-urlencoded");
	...
	public ResponseResult remove(ChatroomModel chatroom) throws Exception {
		...
		HttpURLConnection conn = HttpUtil.CreatePostHttpConnection(rongCloud.getApiHostType(), appKey, appSecret,
				"/chatroom/keepalive/remove.json", "application/x-www-form-urlencoded");
		HttpUtil.setBodyParameter(body, conn);
	...
	public ChatroomKeepaliveResult getList() throws Exception {
		HttpURLConnection conn = HttpUtil.CreatePostHttpConnection(rongCloud.getApiHostType(), appKey, appSecret,
				"/chatroom/keepalive/query.json", "application/x-www-form-urlencoded");

		return (ChatroomKeepaliveResult) GsonUtil.fromJson(
				CommonUtil.getResponseByCode(PATH, CheckMethod.GETLIST, HttpUtil.returnResult(conn)),
				ChatroomKeepaliveResult.class);
	}
}
