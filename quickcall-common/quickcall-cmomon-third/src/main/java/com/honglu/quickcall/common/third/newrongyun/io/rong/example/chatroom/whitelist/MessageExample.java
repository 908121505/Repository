package com.honglu.quickcall.common.third.newrongyun.io.rong.example.chatroom.whitelist;
...
public class MessageExample {
	...
	public static void main(String[] args) throws Exception {
		...
		/**
		 * API:
		 * 文档http://www.rongcloud.cn/docs/server_sdk_api/chatroom/whitelist/message.html#add
		 * 添加聊天室全局禁言
		 */
