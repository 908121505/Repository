package com.honglu.quickcall.common.third.newrongyun.io.rong.methods.message.discussion;
...
public class Discussion {
	 ...
	 *
	 *
	 * @param message:发送消息内容，参考融云消息类型表.示例说明；如果
	 *            objectName 为自定义消息类型，该参数可自定义格式。（必传）
	 *
