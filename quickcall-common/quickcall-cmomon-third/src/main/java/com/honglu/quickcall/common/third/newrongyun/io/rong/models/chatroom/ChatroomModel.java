package com.honglu.quickcall.common.third.newrongyun.io.rong.models.chatroom;
...
public class ChatroomModel {
	 ...
	 * 聊天室构造函数 全量
	 */
	public ChatroomModel(String id, String name, String time, ChatroomMember[] members, Integer count, Integer order,
			Integer minute) {
		this.id = id;
		this.name = name;
		this.time = time;
