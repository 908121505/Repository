...
public class MandaoSmsCodeUtil {
     ...
     * 返 回 值：注册结果（String）
     */
    public static String register(String province, String city, String trade,
     ...
     */
    public static String gxmt(String mobile, String content, String ext, String stime,
                       String rrid) {
        String result = "";
     ...
     * 返 回 值：唯一标识，如果不填写rrid将返回系统生成的
     */
    public static String mdSmsSend_u(String mobile, String content, String ext, String stime,
                              String rrid) {
        String result = "";
    ...
    public static void main(String[] args) {
    	mdSmsSend_u("18217583747","【贷款管家】您的验证码是9999，请在20分钟内完成操作。为了您的账户安全，请勿泄露给他人。","","","");
	}
}
