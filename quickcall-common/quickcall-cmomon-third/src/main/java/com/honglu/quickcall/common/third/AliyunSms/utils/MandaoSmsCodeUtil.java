 ...
 */
public class MandaoSmsCodeUtil {

	private static final Logger logger = LoggerFactory.getLogger(MandaoSmsCodeUtil.class);
	private static final String serviceURL = "http://sdk.entinfo.cn:8060/webservice.asmx";
	private static final String ext = "1";
	private static final String mdwy_ext = "2";
	private static String sn = "SDK-BJR-010-01105";// 序列号
	private static String password = "57$-72e$-40";
	private static String pwd = null;// 加密密码

	static {
		try {
			pwd = getMD5(sn + password);
		} catch (UnsupportedEncodingException e) {
			logger.error("漫道初始化密码异常" + e.getMessage(), e);
		}
	}
	 ...
	 * 值：注册结果（String）
	 */
	public static String register(String province, String city, String trade, String entname, String linkman,
			String phone, String mobile, String email, String fax, String address, String postcode) {
		String result = "";
	 ...
	 */
	public static String chargeFee(String cardno, String cardpwd) {
		String result = "";
	 ...
	 * 值：唯一标识，如果不填写rrid将返回系统生成的
	 */
	public static String gxmt(String mobile, String content, String ext, String stime, String rrid) {
		String result = "";
	 ...
	 */
	public static String UDPPwd(String newPwd) {
		String result = "";
	...
	/**
	 * 参考官方文档, 默认使用 ext , stime ,rrid
	 * 
	 * @param mobile
	 * @param content
	 * @return
	 */
	public static String mdSmsSendSimple(String mobile, String content) {
		return mdSmsSend_u(mobile, content, ext, "", "");
	}
	 ...
	 * @return
	 */
	public static String mdwyMdSmsSendSimple(String mobile, String content) {
		return mdSmsSend_u(mobile, content, mdwy_ext, "", "");
	}
	 ...
	 * 值：唯一标识，如果不填写rrid将返回系统生成的
	 */
	public static String mdSmsSend_u(String mobile, String content, String ext, String stime, String rrid) {
		String result = "";
	...
	public static void main(String[] args) {
		mdSmsSend_u("18217583747", "【轻音互动】您的验证码是9999，请在20分钟内完成操作。为了您的账户安全，请勿泄露给他人。", "", "", "");
	}
}
