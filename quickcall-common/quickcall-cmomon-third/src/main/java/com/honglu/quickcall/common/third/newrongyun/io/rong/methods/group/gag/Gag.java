package com.honglu.quickcall.common.third.newrongyun.io.rong.methods.group.gag;
...
import com.honglu.quickcall.common.third.newrongyun.io.rong.models.response.ListGagGroupUserResult;
...
public class Gag {
	...
	public Result add(GroupModel group) throws Exception {
		 ...
		 * if(null != message){ return (Result)GsonUtil.fromJson(message,Result.class);
		 * }
		 */
