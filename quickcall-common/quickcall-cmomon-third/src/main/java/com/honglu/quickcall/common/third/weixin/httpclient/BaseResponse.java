...
import com.honglu.quickcall.common.third.weixin.util.HTMLEntity;
...
public class BaseResponse implements java.io.Serializable {
    ...
    public BaseResponse(Response res) {
    ...
    protected static void ensureRootNodeNameIs(String rootName, Element elem) throws Exception {
        if (!rootName.equals(elem.getNodeName())) {
            throw new Exception("Unexpected root node name:" + elem.getNodeName() + ". Expected:" + rootName + ". Check the availability of the Weibo API at http://open.t.sina.com.cn/.");
        }
    }

    protected static void ensureRootNodeNameIs(String[] rootNames, Element elem) throws Exception {
        ...
        throw new Exception("Unexpected root node name:" + elem.getNodeName() + ". Expected:" + expected + ". Check the availability of the Weibo API at http://open.t.sina.com.cn/.");
    }

    protected static void ensureRootNodeNameIs(String rootName, Document doc) throws Exception {
    ...
    protected static Date getChildDate(String str, Element elem) throws Exception {
        return getChildDate(str, elem, "EEE MMM d HH:mm:ss z yyyy");
    }

    protected static Date getChildDate(String str, Element elem, String format) throws Exception {
        return parseDate(getChildText(str, elem),format);
    }
    protected static Date parseDate(String str, String format) throws Exception{
