...
public class GagExample {
	...
	public static void main(String[] args) throws Exception {
		...
		GroupModel group = new GroupModel().setId("12").setMembers(members).setMinute(5);
		 ...
		 * 移除禁言群成员
		 */
		group = new GroupModel().setId("IXQhMs3ny").setMembers(members);

		// Result groupRollBackGagUserResult = Gag.remove(group);
		// System.out.println("group.gag.remove: " +
