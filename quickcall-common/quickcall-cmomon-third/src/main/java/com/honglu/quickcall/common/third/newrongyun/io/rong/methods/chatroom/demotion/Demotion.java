package com.honglu.quickcall.common.third.newrongyun.io.rong.methods.chatroom.demotion;
...
import com.honglu.quickcall.common.third.newrongyun.io.rong.models.response.ChatroomDemotionMsgResult;
...
public class Demotion {
	...
	public ChatroomDemotionMsgResult getList() throws Exception {
		...
		return (ChatroomDemotionMsgResult) GsonUtil.fromJson(
				CommonUtil.getResponseByCode(PATH, CheckMethod.GETLIST, HttpUtil.returnResult(conn)),
				ChatroomDemotionMsgResult.class);
	}
}
