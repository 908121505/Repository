...
public class DemotionExample {
	...
	public static void main(String[] args) throws Exception {
		 ...
		 *
		 * API 文档:
		 * http://www.rongcloud.cn/docs/server_sdk_api/chatroom/demotion.html#add
		 * 添加应用内聊天室降级消息
		 *
		 */
		 ...
		 *
		 * API 文档:
		 * http://www.rongcloud.cn/docs/server_sdk_api/chatroom/demotion.html#remove
		 * 移除应用内聊天室降级消息
		 *
		 */
		 ...
		 *
		 * API 文档:
		 * http://www.rongcloud.cn/docs/server_sdk_api/chatroom/demotion.html#getList
		 * 添加聊天室消息优先级demo
		 *
		 */
