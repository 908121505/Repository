...
public abstract class Assertion extends Assert {
	...
	public static void isTrueParameter(Integer value, String message) {
		if (!Detect.isPositive(value) || (value!=1 && value!=2)) {
			throw new IllegalArgumentException(message);
		}
	}
	
	public static void isZhimaParameter(Integer value, String message) {
		if (value==null || (value!=1 && value!=2 && value!=3 && value!=4 && value!=5 )) {
			throw new IllegalArgumentException(message);
		}
	}
	...
	public static void isMobileNO(String mobiles,String message){  
		Pattern p = Pattern.compile("^((13[0-9])|(14[5,7])|(15[0-3,5-9])|(17[0-1,3,5-8])|(18[0-9]))\\d{8}$");
	 ...
	 * 身份证号码匹配
	 */
	public static void isIdCardNO(String idCardNo,String message){
