...
public final class JSONUtil {
     ...
     * @return 对应的map
     */
    public static Map<String, String> toStrMap(String jsonString) {
        BeanUtil.requireNonNull(jsonString, "jsonString is null");
        Map<String, Object> maps = getJSONFromString(jsonString);
        Map<String, String> params = new HashMap<String, String>();
        for (Map.Entry<String, Object> m : maps.entrySet()) {
            params.put(m.getKey().trim(), m.getValue().toString());
        }
        return params;
    }
     ...
     * @return json字符串
     */
    public static String removeJsonKey(String json, String key) {
    	JSONObject jo = JSON.parseObject(json);
    	jo.remove(key);
    	return JSON.toJSONString(jo, DEFAULT_FORMAT);
    }
}
