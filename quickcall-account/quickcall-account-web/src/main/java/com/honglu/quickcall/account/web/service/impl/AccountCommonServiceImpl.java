...
public class AccountCommonServiceImpl implements AccountCommonService {
    private static final Logger logger = LoggerFactory.getLogger(AccountCommonServiceImpl.class);

    @Autowired
    private AccountCommonBusiness accountCommonBusiness;
    ...
    public WebResponseModel execute(AbstractRequest request) {
        ...
        try {
            CommonResponse $response = accountCommonBusiness.excute(request);
