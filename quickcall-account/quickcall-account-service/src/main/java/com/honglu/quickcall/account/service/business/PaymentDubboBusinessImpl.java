...
@Service("Account.PaymentDubboBusiness")
public class PaymentDubboBusinessImpl implements PaymentDubboBusiness {

    private static final Logger logger = LoggerFactory.getLogger(PaymentDubboBusinessImpl.class);
