                ...
                <table class="table dataTable no-footer" role="grid" aria-describedby="example_info">
                    ...
                    <c:forEach var="info" items="${list}">
                        <tr role="row" class="odd">
                            ...
                            <td class="text-center">${info.total + info.listCount}</td>
                            <td class="text-center">${info.listCount}</td>
                            <td class="text-center">${info.count}</td>
                            <td class="text-center">${info.date}</td>
                            <td class="text-center">${info.applyCount}</td>
                            <td class="text-center">${info.date}</td>
                        </tr>
                    </c:forEach>
                    </tbody>
...
<script>
    $(function() {
        ...
        $("#pName").html('<font color="red">'+ name + '</font>' + "产品详情数据列表");
    });
</script>
