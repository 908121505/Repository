...
<shiro:hasPermission name="raiderscate:select">
	<div class="content1">
		<div class="header">
		...
		<div class="main-content">
			<div class="row">
				...
				<div class="col-md-2">
					<shiro:hasPermission name="raiderscate:add">
		...
		<script>
			...
			$(document).ready(function() {
				var table = $('#example').initTable({
					sAjaxSource:"raiderscate/initTable.htm",
					aoColumns: [
			            { 
			              "data": "raidersTitle",
			              "sTitle":"标题",
			            ...
			            <shiro:hasPermission name="raiderscate:update or raiderscate:delete">
			            ,{"data": "raidersCateId","sTitle":"操作",'sClass':"text-center"}
			            </shiro:hasPermission>
			         ],
		             ...
		             aoColumnDefs : [
						<shiro:hasPermission name="raiderscate:update or raiderscate:delete">
		             	{"aTargets" :6,"mRender" : function(data, type, row){
		             		var edit="",del="";
		             		<shiro:hasPermission name="raiderscate:update">
		             		...
		             		<shiro:hasPermission name="raiderscate:delete">
			...
			function deleteRow(id){
				console.log(id);
				$('#myModal').deleteRow('raiderscate/del.htm?id='+id);
			}
			//增加或者修改受影响的行数
			function addAndUpdateRow(id){
				$('#insertAndUpdate').addAndUpdateRow("raiderscate/addAndUpdateHome.htm?id="+id);
			}
			</script>
		<!---dialog选项-->
		<div>
