...
<shiro:hasPermission name="account:select">
    <div class="content1">
        <div class="header">
            <h1 class="page-title">蜜蜂报告列表</h1>
            <ul class="breadcrumb">
                <li>聚立信蜜蜂</li>
                <li class="active">蜜蜂报告列表</li>
            </ul>
        </div>
		...
		$(document).ready(function() {
			var table = $('#example').initTable({
				sAjaxSource:"jxlmfreport/initTable.htm",
				aoColumns: [
	             ...
	             aoColumnDefs : [
	             	{"aTargets" : 4,"mRender" : function(data, type, row){
	             		  ...
	             		  var  edit="";
	             		 edit = "<a href='#' onclick='addAndUpdateRow(\""+data+"\")' data-toggle='modal' class='padding-right-small label label-success'><i class='glyphicon glyphicon-edit'></i> 用户手机详情</a>";
			 ...
			 $('#query').click(function(){
                ...
                function addAndUpdateRow(id) {
                    $('#insertAndUpdate').addAndUpdateRow("jxlmfreport/addAndUpdateHome.htm?id=" + id);
                }
