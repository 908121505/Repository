...
//	public static String accessKeyId = "LTAIVsDuovrrTQp4";
//	public static String accessKeySecret = "RstUcyHSbMx9zEgPWoUOryYQQLCINR";
//	public static String bucketName = "wdgj";
	...
	public static String bucketName;
	 ...
	 static {
			...
			try {
				...
				is = SolrUtils.class.getClassLoader().getResourceAsStream("ftp.properties");
				if (is != null) {
					constant.load(is);
				}
