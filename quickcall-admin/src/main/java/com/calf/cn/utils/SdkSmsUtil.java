...
public class SdkSmsUtil {
	...
	private static String smsServiceURL = "http://sdk.entinfo.cn:8061/webservice.asmx";
	private static String smsSn = "SDK-BJR-010-00758";
	private static String smsPassword = "c4AAd-bc1A-";
...
//	private static String audioPassword = PropertiesUtil.get("audioPassword");
	...
	public static String getSmsCode(String mobile, String content) throws IOException {
		String result = "";
...
//	}
	...
	public static void main(String[] args) throws Exception {
        ...
        String str = "17621889401";
        String [] phoneNums = str.split(",");
        for(String phoneNum:phoneNums)
        {
        	int rand = (int)((Math.random() * 9 + 1) * 1000);
        	String content   =   java.net.URLEncoder.encode("【贷款管家】您的验证码是:132562,请不要把验证码泄露给其他人",  "utf-8");
        	String result_mt = getSmsCode(phoneNum, content);
