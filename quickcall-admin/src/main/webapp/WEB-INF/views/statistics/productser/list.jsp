...
<shiro:hasPermission name="productser:statistics:select">
    <div class="content1">
        <div class="header">
        ...
        <script>
            ...
            $(document).ready(function () {
                var table = $('#example').initTable({
                    sAjaxSource: "productser/statistics/initTable.htm",
                    aoColumns: [
                        {
                            "data": "productName",
                            "sTitle": "合作平台名称",
                        ...
                        },
                        {
                            ...
                            "mRender": function (data, type, full) {
                                return "<a href='' onclick='statisticsDetail(this)' data-date="+full.date+" data-apply='0' data-name=" +
                                    full.productId + "  data-toggle='modal'><u>" + data + "</u></a>"
                            }
                        },
                        {
                            "data": "date",
                        ...
                        },
                        {
                            ...
                            'sClass': "text-center",
                            "mRender": function (data, type, full) {
                                return "<a href='' onclick='statisticsDetail(this)'data-date="+full.date+"  data-apply='1' data-name=" +
                                    full.productId + "  data-toggle='modal'><u>" + data + "</u></a>"
                            }
                        }
                    ],
            ...
            function statisticsDetail(obj) {
                ...
                $('#insertAndUpdate').addAndUpdateRow("arrondi/statistics/detail.htm?type=2&name=" + name + "&apply="+ apply + "&date=" + date);
            }
