            ...
            <%--<div class="col-md-2">
                <div class="form-group">
                    <div class="input-group">
                        <div class="input-group-addon">职业名称</div>
                        <input class="form-control" type="text" id="occupationName">
                    </div>
                </div>
            </div>--%>
            <div class="col-md-2">
        ...
        <script>
            ...
            $(document).ready(function() {
                var table = $('#example').initTable({
                    sAjaxSource:"occupation/initTable.htm",
                    aoColumns: [
                        {
                            "data": "id",
                            "sTitle":"职业ID",
            ...
            function addAndUpdateRow(id){
                $('#insertAndUpdate').addAndUpdateRow("occupation/addAndUpdateHome.htm?id="+id);
            }

            //删除受影响的行数
            function deleteRow(id) {
                $('#myModal').deleteRow('occupation/del.htm?id=' + id);
            }
        </script>
        <!---dialog选项-->
        <div>
