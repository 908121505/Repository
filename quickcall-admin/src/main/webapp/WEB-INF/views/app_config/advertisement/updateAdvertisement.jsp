    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <form class="form-horizontal" method="post" id="sysUserForm" name="advertisementForm"
                ...
                <input type="hidden" class="form-control" name="imageUrl" id="advertisementImgFile_input" value="${entity.imageUrl }">
                <div class="form-group">
                    <label class="col-sm-2 control-label">广告标题<font color="red">&nbsp;*</font></label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control required" id="title" name="title" value="${entity.title }">
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control required" id="adDescrible" name="adDescrible" value="${entity.adDescrible }">
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <div class="col-sm-6">
                            <img src="${entity.imageUrl }" alt="暂无图片" class="img-rounded" style="max-width: 100%; max-height: 300px;" id="imageUrl">
                        </div>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div>
                    <label class="col-sm-2 control-label">生效版本<font color="red">&nbsp;*</font></label>
                    <div class="col-sm-10">
                ...
                <%--<div class="form-group">
                    <label class="col-sm-2 control-label">生效版本<font color="red">&nbsp;*</font></label>
                    <div class="col-sm-10">
                        <select class="form-control" id="appVersion" name="appVersion">
                            <option value="1" >1.0.0</option>
                            <option value="2" >1.0.1</option>
                            <option value="3" >1.0.2</option>
                        </select>
                    </div>
                </div>--%>
