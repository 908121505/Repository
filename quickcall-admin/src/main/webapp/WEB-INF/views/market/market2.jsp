...
<style type="text/css">
	...
	<div class="content1">
		<div class="header">
			<h1 class="page-title">市场成效 三合一</h1>
				...
				<div class="col-md-2">
					<div class="form-group">
						<div class="input-group">
							...
							<option value="byCurrent">实时</option>
							<option value="byDate">当日</option>
							<option value="marketEffect">市场成效</option>
		...
		function Format(now,mask)
		{
			...
			$(document).ready(function() {
				...
				var table = $('#example').initTable({
					sAjaxSource:"account/queryLoginAndRegAndApplyNumTotal",
			...
			function  inputChange(obj){
			 ...
			 function exportUserInfo(){
	                var href="export/marketThree.htm"
