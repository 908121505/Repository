		...
		<div class="modal-body" style="max-height: 700px; overflow-y: auto;"  id = "editBody">
			<form class="form-horizontal" method="post" id="skillPriceLevelForm" name="skillPriceLevelForm" role="form"
				...
				<div class="form-group">
					...
					<div class="col-sm-6">
						<textarea id="feedBackContent" name="feedBackContent" rows="6" cols="20"class="form-control" >${entity.feedBackContent}</textarea>
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-sm-6">
						<input type="text" class="form-control" name="contactWay" value="${entity.contactWay}" />
					</div>
				</div>
				<div class="form-group">
