...
<div class="content1">
            ...
            <div class="col-md-2">
                <div class="form-group">
                    <div class="input-group">
                        ...
                        <div class="input-group-addon">大V认证状态</div>
                        <select class="form-control" id="vStatus" name="vStatus">
    ...
    <script>
        ...
        $(document).ready(function () {
            var table = $('#example').initTable({
                ...
                fnServerParams: function (aoData) {  //查询条件
                    ...
                    aoData.push({"name": "vStatus", "value": $("#vStatus").val()});
                },
                aoColumnDefs: [
                    {
        ...
        function approvedFn(customerId) {
            if (window.confirm("确认通过审核？")) {
                doCheck(customerId, 2);
            }
        }
        ...
        function doCheck(customerId, vStatus) {
            $.ajax({
