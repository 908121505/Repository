...
<div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h3 id="myModalLabel">${empty entity?'新增折扣':'修改折扣' }</h3>
        </div>
        <div class="modal-body" style="max-height: 700px; overflow-y: auto;"  id = "editBody">
            <form class="form-horizontal" method="post" id="skillForm"
                  name="skillForm"
                  action="discount/save${empty entity?'Insert':'Update' }.htm"
                  role="form">
                <input type="hidden" id="id" class="form-control"  name="id" value="${entity.id}" >
                <div class="form-group">
                    <label class="col-sm-2 control-label">技能<font color="red">&nbsp;*</font></label>
                    <div class="col-sm-10">
                        <select class="form-control" id="skillItemId" name="skillItemId">
                ...
                <div class="form-group" >
                    ...
                    <div class="col-sm-8">
                        <input type="text" id="discount" class="form-control" name="discount" value="${entity.discount}">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <label class="checkbox-inline">
                            <input type="radio" name="skillExtStatus" value="1" ${empty entity or entity.skillExtStatus=='1'?'checked':'' }>
                            开启
                        </label>
                        <label class="checkbox-inline">
                            <input type="radio" name="skillExtStatus" value="0" ${entity.skillExtStatus=='0'?'checked':'' }>
                            关闭
                        </label>
                    </div>
                </div>
               ...
               <%-- <div class="form-group">
                ...
                &lt;%&ndash; 4=已封禁-无法接单,6=已封禁-无法接指定技能,8=已封禁-账户登录权限,10=已封禁-设备登录权限&ndash;%&gt;
                <div class="form-group"  >
                    <label class="col-sm-4 control-label">用户类型<font color="red">&nbsp;*</font></label>
                    <div class="col-sm-8">
        ...
        $.ajax({
            ...
            success: function (data) {
                for(i=0;i<data.length;i++){
                    ...
                    <%--if(data[i].name == ${entity.skillItemName}){--%>
                        <%--$('#skillItemId').append("<option value="+data[i].id+" selected=\"selected\">"+data[i].name+"</option>");--%>

                        $('#skillItemId').append("<option value="+data[i].id+">"+data[i].name+"</option>");
