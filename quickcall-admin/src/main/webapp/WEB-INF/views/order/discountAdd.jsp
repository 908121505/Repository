...
<script type="text/javascript" language="javascript" src="resources/bootstrap/js/bootstrap-datetimepicker.min.js"
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <label class="checkbox-inline">
                            <input type="radio" name="skillExtStatus"
                                   value="1" ${empty entity or entity.skillExtStatus=='1'?'checked':'' }>
                            开启
                        </label>
                        <label class="checkbox-inline">
                            <input type="radio" name="skillExtStatus"
                                   value="0" ${entity.skillExtStatus=='0'?'checked':'' }>
                            关闭
                        </label>
                    </div>
                </div>
