	...
	<div class="modal-content">
		...
		<div class="modal-body">
			<form class="form-horizontal" method="post" id="productLabelForm" name="productLabelForm"
				action="productLabel/save${empty entity?'Insert':'Update' }.htm"
				role="form">
				<div class="form-group">
					...
					<div class="col-sm-10">
					   <c:if test="${empty entity==false}">
							...
							<input type="hidden" value="${entity.labelCode }" id="label_code" name="labelCode" />
...
<script type="text/javascript">
	 ...
	 $("#productCategoryId").val('${entity.productCategoryId}');
	...
	function check_fun(){
		...
		var labelCategoryId = $("#productCategoryId").val();
