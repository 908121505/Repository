		...
		<div class="modal-body">
			<form class="form-horizontal" method="post" id="sysUserForm" name="bannerForm"
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<select class="form-control" id="bannerType" name="bannerType">
							...
							<%--  <option value="3"  ${entity.bannerType=='3'?'selected':''}>活动banner</option>--%>
							<%--<option value="4"  ${entity.bannerType=='4'?'selected':''}>看看我能贷什么</option>--%>
							<option value="5"  ${entity.bannerType=='5'?'selected':''}>社区banner</option>
							<%--<option value="6"  ${entity.bannerType=='6'?'selected':''}>首页对抗催收</option>--%>
							<%--<option value="7"  ${entity.bannerType=='7'?'selected':''}>专区banner</option> --%>
							<%--<option value="8"  ${entity.bannerType=='7'?'selected':''}>赚钱banner</option>--%>
				...
				<div class="form-group">
				 ...
				 <div class="form-group">
					<label class="col-sm-2 control-label">所属专区</label>
					<div class="col-sm-10">
				    	<select class="form-control" id="zoneId" name="zoneId">
						     <option value="">请选择</option>						 
						      <<c:forEach var="maps" items="${init}">						  
						         <option value="${maps.zoneId}"   ${maps.zoneId eq entity.zoneId?'selected="selected"':''} >${maps.zoneName}</option>						      
						      </c:forEach>
						</select>
