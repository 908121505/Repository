...
(function () {
     ...
     */
    var URL = window.UEDITOR_HOME_URL || 'resources/ueditor/';
    var appWebRoot = "http://localhost:81/calfQuickenLoansWeb/";
    /**
...
//        //图片上传配置区
        ,imageUrl:appWebRoot+"upload/upload.htm"             //图片上传提交地址
        ...
        ,savePathUrl:appWebRoot+"upload/type.htm" //**** 自定义配置 远程获取上传目录列表,不使用savePath
